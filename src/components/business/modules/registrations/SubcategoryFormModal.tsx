...
import { Hash, Save, Tag, Star, Zap, Heart, Crown, Shield, Flame, Snowflake, Sun, Moon, Clock, Gift, Award, Target, Compass, Anchor, Feather, Gem } from 'lucide-react';
...
export const SubcategoryFormModal: React.FC<SubcategoryFormModalProps> = ({
  ...
  const { businessId, categories, subcategories } = useBusiness();
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const existingSubcategory = subcategories.find(sub => 
    ...
    try {
      const subcategoryData = {
        ...
        businessId,
        sortOrder: initialData?.sortOrder || subcategories.filter(s => s.categoryId === formData.categoryId).length,
      ...
      <div className="grid grid-cols-2 gap-16 h-96">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <FormField label="Nome da Subcategoria">
                <input
                  ...
                  placeholder="Ex: Refrigerantes, Massas, Tortas"
                  required
                />
              </FormField>
        ...
        <div className="space-y-6">
          <div>
            ...
            {/* Grid de ícones - 6 colunas x 3 linhas = 18 ícones sem scroll */}
