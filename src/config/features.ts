...
export const FEATURE_MAP: Record<string, any> = {
    ...
    'financeiro_plano':        { label: 'Financeiro & Plano', icon: DollarSign, group: 'financeiro' },
    'compras_ver':             { label: 'Compras', icon: ShoppingCart, group: 'financeiro' },
    'compras_orcamentos':      { label: 'Orçamentos', icon: FileText, group: 'financeiro' },

    // --- MARKETING & ADS (Recuperado) ---
    'marketing':                { label: 'Impulso Marketing', icon: TrendingUp, group: 'marketing' }, // MODULO IMPULSO MARKETING
    ...
    'recuperador_de_vendas':    { label: 'Recuperador de Vendas', icon: RotateCcw, group: 'marketing' },
    ...
    'loja_extensoes':           { label: 'Loja de Extensões', icon: Puzzle, group: 'sistema' },
